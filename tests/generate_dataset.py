...
def make_email(subject, from_addr, body, to_addr="user@baosight.com", from_name="",
...
def main():
    ...
    samples += [
        save("phish_01_spoof_leader.eml", make_email(
            ...
            from_addr="director@baosightt.com",
            from_name="王总监",
