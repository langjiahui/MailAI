...
assert.match(html, /select-ui\.css\?v=[^"']+/, 'shared select styles must load after component styles');
...
assert.match(css, /html\[data-theme="dark"\][^\n]*select option \{ color: #e6eee9; background: #141b17; \}/, 'dark native menu options must remain legible');
